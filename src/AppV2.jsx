...
const callGemini = async (prompt, systemInstruction) => {
    ...
    try {
        ...
        if (lowerPrompt.includes("cobras")) return localKnowledgeBase.cobro;
...
// Componente para transiciones animadas de página
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-white font-bold text-lg flex items-center gap-2 font-serif">
                            Eddu-AI <span className="text-[10px] bg-[#bf953f]/20 text-[#bf953f] px-2 py-0.5 rounded-full border border-[#bf953f]/30 font-sans tracking-wide">ABOGADO SENIOR v3.0</span>
                        </h3>
            ...
            detail: (
                <div className="space-y-8 animate-fade-in">
                    ...
                    <div className="grid gap-6">
                        <h4 className="text-[#bf953f] font-bold uppercase tracking-widest text-sm border-b border-gray-800 pb-2">Conceptos Críticos</h4>
            ...
            detail: (
                <div className="space-y-8 animate-fade-in">
                    <div className="bg-[#0a0a0a] p-6 border border-[#bf953f] rounded-sm shadow-[0_0_20px_rgba(191,149,63,0.1)]">
                        <h3 className="text-xl font-bold text-[#bf953f] mb-4">La Cadena de Custodia Digital</h3>
    ...
    return (
        <PageTransition>
            <div className="min-h-screen pt-24 px-6 pb-12 w-full bg-[#050505]">
                <Link to="/" className="flex items-center text-[#d4af37] mb-8 hover:text-white transition-colors"><ArrowLeft className="w-5 h-5 mr-2" /> Volver al Inicio</Link>
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-12 gap-8">
                            ...
                            {modules.map((mod) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className={`font-bold text-lg mb-2 ${activeModule?.id === mod.id ? 'text-white' : 'text-gray-300'}`}>{mod.title}</h3>
                        ...
                        <div className="lg:col-span-8 bg-[#111] border border-[#333] p-10 rounded-sm min-h-[500px] shadow-2xl relative">
                            {activeModule ? (
                                <>
        ...
        <PageTransition>
            ...
            <section className="relative min-h-screen flex items-center justify-center pt-20">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-serif font-bold mb-8 leading-tight text-white drop-shadow-lg">El Correo Electrónico: <br /><span className="bg-clip-text text-transparent" style={{ backgroundImage: theme.goldGradient }}>Tu Seguro de Vida Inmobiliario</span></h1>
            ...
            <section id="mito" className="py-24 relative bg-[#050505]">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-serif font-bold mb-4 text-[#d4af37]">Análisis Forense Digital: WhatsApp vs Email</h2>
                    ...
                    <div className="overflow-x-auto">
                        <div className="hidden md:block min-w-[800px] bg-[#111] rounded-sm border border-[#333] shadow-2xl">
                            {/* HEADER TABLA */}
                            <div className="grid grid-cols-3 bg-[#1c1c1c] border-b border-[#333] p-6 text-sm font-bold tracking-widest uppercase">
                                <div className="text-gray-500 flex items-center gap-2"><Scale className="w-4 h-4" /> Variable Jurídica</div>
                                <div className="text-red-500 flex items-center gap-2"><AlertTriangle className="w-4 h-4" /> WhatsApp / Chats</div>
                                <div className="text-[#bf953f] flex items-center gap-2"><Shield className="w-4 h-4" /> Correo Certificado</div>
                            </div>
                            ...
                            {[
                                ...
                                <div key={idx} className={`grid grid-cols-3 border-b border-[#222] p-6 text-sm hover:bg-[#161616] transition-colors`}>
                                    <div className="font-bold text-gray-300">{row.title}</div>
                                    <div className="text-gray-500 flex items-start gap-2"><XCircle className="w-4 h-4 text-red-900 mt-0.5 flex-shrink-0" /> {row.chat}</div>
                                    <div className="text-white flex items-start gap-2"><Check className="w-4 h-4 text-[#bf953f] mt-0.5 flex-shrink-0" /> {row.email}</div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="md:hidden space-y-6">
                            {[
                                ...
                                <div key={idx} className="bg-[#111] rounded-sm border border-[#333] p-6 shadow-xl">
                                    <div className="font-bold text-white mb-4 border-b border-[#333] pb-2 flex items-center gap-2">
                                        <Scale className="w-4 h-4 text-gray-500" /> {row.title}
                                    </div>
                                    <div className="space-y-4">
                                        <div>
                                            <div className="text-xs font-bold text-red-500 uppercase tracking-widest mb-1 flex items-center gap-2"><AlertTriangle className="w-3 h-3" /> WhatsApp</div>
                                            <div className="text-gray-400 text-sm flex items-start gap-2"><XCircle className="w-4 h-4 text-red-900 mt-0.5 flex-shrink-0" /> {row.chat}</div>
                                        </div>
                                        <div>
                                            <div className="text-xs font-bold text-[#bf953f] uppercase tracking-widest mb-1 flex items-center gap-2"><Shield className="w-3 h-3" /> Correo Certificado</div>
                                            <div className="text-white text-sm flex items-start gap-2"><Check className="w-4 h-4 text-[#bf953f] mt-0.5 flex-shrink-0" /> {row.email}</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                <div className="max-w-5xl mx-auto px-6 text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-[#1c1c1c] p-8 rounded-sm border border-[#333] flex flex-col items-center hover:border-gray-500 transition-colors">
                            <Mail className="w-12 h-12 text-[#10b981] mb-6" /><h3 className="text-xl font-bold text-white mb-2">MailSuite</h3><p className="text-sm text-gray-400 mb-6 max-w-sm text-center">Rastreo de apertura de correos para saber cuándo leyeron tu oferta.</p><Link to="/soporte" className="text-[#d4af37] text-xs font-bold uppercase hover:underline">Pregúntale a Eddu</Link>
                        </div>
                        <div className="bg-[#1c1c1c] p-8 rounded-sm border border-[#333] flex flex-col items-center hover:border-gray-500 transition-colors">
                            <FileCheck className="w-12 h-12 text-[#10b981] mb-6" /><h3 className="text-xl font-bold text-white mb-2">4-72 Certificado</h3><p className="text-sm text-gray-400 mb-6 max-w-sm text-center">Prueba de entrega oficial válida en juzgados para notificaciones.</p><Link to="/soporte" className="text-[#d4af37] text-xs font-bold uppercase hover:underline">Pregúntale a Eddu</Link>
                        </div>
                    </div>
                </div>
            </section>
